...
// Change them to an  y values of your choice (except loggedIn => that should be changed to true)
...
function App() {
  ...
  function saveInfo() {
    ...
    if (username && password) user.loggedIn = true;
    console.log(user);
  }
  ...
  return (
    <div id="app">
      ...
      <p id="actions">
        <button onClick={saveInfo}>Login</button>
      </p>
    </div>
  );
}
